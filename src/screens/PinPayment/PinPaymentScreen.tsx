import { usePaymentWallet } from "@/apis/hooks/wallet";
...
const PinPaymentScreen = () => {
  ...
  const { mutate: paymentWallet } = usePaymentWallet();
  ...
  const handleSubmit = () => {
    ...
    const body = {
      ...
      pin,
      payload: params.payload ? JSON.parse(params.payload as string) : null,
    };
...
export default PinPaymentScreen;
